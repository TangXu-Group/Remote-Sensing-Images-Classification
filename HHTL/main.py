...
from models.combine_model import CombineVisionTransformerc
    ...
    for epoch in range(args.epoch):
        ...
        with tqdm(train_loader, desc=description) as iterator:
            for step, (img, img_slic, label) in enumerate(iterator):
                ...
                loss = ce_loss + (contrast0_loss + contrast1_loss) * 0.05
        ...
        if epoch % 1 == 0:
            ...
            f = open(os.path.join(args.log_dir,'save_'+args.dataset+'_slic.log'), 'a')
...
def main():
    root_path = '/home/admin1/lmt/pytorch_project/transformer_ViT/'

    parser = argparse.ArgumentParser()
    # Required parameters
    parser.add_argument("--name", default='AID55_best',
                        help="Name of this run. Used for monitoring.")
    parser.add_argument("--dataset", default="AID55",
                        help="data path.")
    parser.add_argument("--dataset_slic", default="AID55_slic",
                        help="slic path.")
    ...
    label_dict = {'UC_Merced': 21, 'NWPU': 45, 'AID': 30, 'RSSDIVCS': 70, 'AID55': 30}
